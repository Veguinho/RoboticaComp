...
### VIDEO NO YOUTUBE: https://www.youtube.com/watch?v=15LvyOP7caE&feature=youtu.be ####
...
def identifica_cor(frame):
    ...
    opening = cv2.morphologyEx(segmentado_cor , cv2.MORPH_OPEN, kernel)
    ...
    #36,7cm - 285px(90cm) - !!!!!700px = distancia focal!!!!!!!
